      ...
      <div className="flex flex-1 flex-col md:flex-row">
          ...
          <div className="w-full max-w-md space-y-8 bg-gray-50 dark:bg-[#131a24] p-8 rounded-2xl shadow-sm border border-gray-200 dark:border-[#2a3343]">
            ...
            <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                <button
                  type="submit"
                  disabled={isAuthenticating || !email || !password || !displayName || password.length < 6}
        ...
        <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-indigo-600 via-purple-600 to-purple-700 items-center justify-center">
          <div className="max-w-md text-center px-8">
            <h2 className="text-3xl font-bold text-white mb-4">Join our music community</h2>
            <p className="text-indigo-100 mb-6">
              Create an account to save your favorite songs, build playlists, 
              and get personalized recommendations based on your music taste.
            </p>
            <TestimonialScroller />
          </div>
        </div>
